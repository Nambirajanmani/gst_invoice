...
/* helper – pull first item's per_unit label */
$perLabel = sanitize($inv['items'][0]['per_unit'] ?? 'Unit');
?><!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
  ...
  <table class="inv-tbl">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><?= number_format((float)($item['rate'] ?? 0)) ?></td>
    ...
    <tfoot>
      <tr>
        <td colspan="6" class="empty" style="text-align:left"></td>
