...
// Pre-fill from session (after preview)
session_start();
...
<form method="POST" action="save-invoice.php" enctype="multipart/form-data" id="mainForm">
...
<?php foreach ($templates as $key => $tpl): $c=$tpl['color']; ?>
      <div class="tpl-opt">
        <input type="radio" name="template" id="<?=$key?>" value="<?=$key?>" <?=$key==='t01'?'checked':''?>>
        <label for="<?=$key?>">
...
<?php endforeach; ?>
  ...
  <div class="card">
    ...
    <div class="form-row">
      <div class="form-group col-full">
        ...
        <input type="text" name="company_name" required value="<?= sanitize($prefill['company_name'] ?? '') ?>" placeholder="e.g. Roshan Traders">
      </div>
    </div>
    <div class="form-row-3">
      ...
      <div class="form-group">
        <label>Phone</label>
        <input type="text" name="company_phone" value="<?= sanitize($prefill['company_phone'] ?? '') ?>" placeholder="+91 99999 00000">
      </div>
      <div class="form-group">
        <label>Email</label>
    ...
    <div class="form-row-3">
      <div class="form-group">
        ...
        <input type="text" name="bank_account" value="<?= sanitize($prefill['bank_account'] ?? '') ?>" placeholder="279150310875046">
      </div>
      <div class="form-group">
        <label>IFSC Code</label>
        <input type="text" name="bank_ifsc" value="<?= sanitize($prefill['bank_ifsc'] ?? '') ?>" placeholder="TMBL0000279" style="text-transform:uppercase">
      </div>
      <div class="form-group">
        <label>Branch Name</label>
        <input type="text" name="bank_branch" value="<?= sanitize($prefill['bank_branch'] ?? '') ?>" placeholder="KALAKAD">
      </div>
    </div>
  ...
  <div class="card">
    ...
    <div class="form-group">
      <label>Bill To / Customer Name <span style="color:red">*</span></label>
      <input type="text" name="bill_to" required value="<?= sanitize($prefill['bill_to'] ?? '') ?>" placeholder="Customer name or company">
    </div>
  </div>
      ...
      <table class="items-table">
        ...
        <tbody id="items-tbody">
          <tr class="item-row" data-index="0">
            <td style="text-align:center">1<input type="hidden" name="items[0][serial]" value="1"></td>
            <td><input type="text" name="items[0][description]" class="i-desc" placeholder="Item description" required></td>
            <td><input type="text" name="items[0][hsn]" class="i-hsn" placeholder="HSN" style="width:85px"></td>
            <td><input type="number" name="items[0][quantity]" class="i-qty" min="0" step="0.001" placeholder="0"></td>
            <td><input type="text" name="items[0][per_unit]" class="i-per" placeholder="Bricks" style="width:70px"></td>
            <td><input type="number" name="items[0][rate]" class="i-rate" min="0" step="0.01" placeholder="0.00"></td>
            <td class="gst-cell i-cgst">₹0.00<input type="hidden" name="items[0][cgst]" class="i-cgst-val" value="0"></td>
            <td class="gst-cell i-sgst">₹0.00<input type="hidden" name="items[0][sgst]" class="i-sgst-val" value="0"></td>
            <td class="auto-cell i-total">₹0.00
              <input type="hidden" name="items[0][base]" class="i-base" value="0">
              <input type="hidden" name="items[0][amount]" class="i-amount-val" value="0">
            </td>
