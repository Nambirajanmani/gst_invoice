...
// Increment the counter when saving/previewing
$actualNumber = incrementInvoiceCounter(); // Returns "0001"
$actualInvoiceNumber = 'INV-' . $actualNumber; // Creates "INV-0001"

// Override the POST invoice_number with our new sequential number
...
// [Keep all the remaining code exactly as is]
